...
container[CognitiveServicesAccessToken] = lambda c: c[TokenCredential].get_token("https://cognitiveservices.azure.com/.default")  # XXX? not really used
...
container[StateGraph] = lambda c: c[StateGraphFactory].create()  # type: ignore[unused-ignore]
