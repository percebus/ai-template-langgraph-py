...
class ChannelWrite(RunnableCallable):
    ...
    def __init__(self, writes: Sequence[ChannelWriteEntry | ChannelWriteTupleEntry | Send], *, tags: Sequence[str] | None = ...) -> None:
        ...
    ...
    @staticmethod
    def do_write(config: RunnableConfig, writes: Sequence[ChannelWriteEntry | ChannelWriteTupleEntry | Send], allow_passthrough: bool = ...) -> None:
        ...
    ...
    @staticmethod
    def register_writer(runnable: R, static: Sequence[tuple[ChannelWriteEntry | Send, str | None]] | None = ...) -> R:
