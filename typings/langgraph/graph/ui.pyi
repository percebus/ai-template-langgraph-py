...
__all__ = ("UIMessage", "RemoveUIMessage", "AnyUIMessage", "push_ui_message", "delete_ui_message", "ui_message_reducer")
...
def push_ui_message(name: str, props: dict[str, Any], *, id: str | None = ..., metadata: dict[str, Any] | None = ..., message: AnyMessage | None = ..., state_key: str | None = ..., merge: bool = ...) -> UIMessage:
