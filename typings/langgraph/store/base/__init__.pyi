...
class SearchItem(Item):
    ...
    __slots__ = ...
    def __init__(self, namespace: tuple[str, ...], key: str, value: dict[str, Any], created_at: datetime, updated_at: datetime, score: float | None = ...) -> None:
...
class BaseStore(ABC):
    ...
    def get(self, namespace: tuple[str, ...], key: str, *, refresh_ttl: bool | None = ...) -> Item | None:
    ...
    def search(self, namespace_prefix: tuple[str, ...], /, *, query: str | None = ..., filter: dict[str, Any] | None = ..., limit: int = ..., offset: int = ..., refresh_ttl: bool | None = ...) -> list[SearchItem]:
    ...
    def put(self, namespace: tuple[str, ...], key: str, value: dict[str, Any], index: Literal[False] | list[str] | None = ..., *, ttl: float | None | NotProvided = ...) -> None:
    ...
    def list_namespaces(self, *, prefix: NamespacePath | None = ..., suffix: NamespacePath | None = ..., max_depth: int | None = ..., limit: int = ..., offset: int = ...) -> list[tuple[str, ...]]:
    ...
    async def aget(self, namespace: tuple[str, ...], key: str, *, refresh_ttl: bool | None = ...) -> Item | None:
    ...
    async def asearch(self, namespace_prefix: tuple[str, ...], /, *, query: str | None = ..., filter: dict[str, Any] | None = ..., limit: int = ..., offset: int = ..., refresh_ttl: bool | None = ...) -> list[SearchItem]:
    ...
    async def aput(self, namespace: tuple[str, ...], key: str, value: dict[str, Any], index: Literal[False] | list[str] | None = ..., *, ttl: float | None | NotProvided = ...) -> None:
    ...
    async def alist_namespaces(self, *, prefix: NamespacePath | None = ..., suffix: NamespacePath | None = ..., max_depth: int | None = ..., limit: int = ..., offset: int = ...) -> list[tuple[str, ...]]:
